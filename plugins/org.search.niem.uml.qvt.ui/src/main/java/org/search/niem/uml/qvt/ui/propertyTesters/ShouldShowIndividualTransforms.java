...
public class ShouldShowIndividualTransforms extends PropertyTester {

    @Override
    public boolean test(final Object receiver, final String property, final Object[] args, final Object expectedValue) {
        return Activator.getPlugin().getPreferenceStore().getBoolean(P_SHOW_INDIVIDUAL_TRANSFORMS);
    }
}
