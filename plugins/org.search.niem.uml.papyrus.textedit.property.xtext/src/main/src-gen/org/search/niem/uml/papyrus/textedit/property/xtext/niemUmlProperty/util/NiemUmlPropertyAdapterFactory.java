 ...
 * @generated
 */
public class NiemUmlPropertyAdapterFactory extends AdapterFactoryImpl
{
  /**
   ...
   * @generated
   */
  protected static NiemUmlPropertyPackage modelPackage;
   ...
   * @generated
   */
  public NiemUmlPropertyAdapterFactory()
  {
    if (modelPackage == null)
    {
      modelPackage = NiemUmlPropertyPackage.eINSTANCE;
    }
  }
   ...
   * @generated
   */
  protected NiemUmlPropertySwitch<Adapter> modelSwitch =
    new NiemUmlPropertySwitch<Adapter>()
    {
      @Override
      ...
      @Override
      public Adapter caseUmlProperty_PropertyRule(org.eclipse.papyrus.uml.textedit.property.xtext.umlProperty.PropertyRule object)
      {
        return createUmlProperty_PropertyRuleAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.search.niem.uml.papyrus.textedit.property.xtext.niemUmlProperty.PropertyRule <em>Property Rule</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.search.niem.uml.papyrus.textedit.property.xtext.niemUmlProperty.AggregationRule <em>Aggregation Rule</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createUmlProperty_PropertyRuleAdapter()
  {
    return null;
  }
