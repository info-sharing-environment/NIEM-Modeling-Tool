...
public class IsInReferenceLibrarySubset extends PropertyTester {
    @Override
    public boolean test(final Object receiver, final String property, final Object[] args, final Object expectedValue) {
        return receiver instanceof IUMLEditPart && isInReferenceLibrarySubset(((IUMLEditPart) receiver).getUMLElement());
    }
}
